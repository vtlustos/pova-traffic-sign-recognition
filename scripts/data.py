...
splits_path = os.path.join(PATH, "mtsd", "splits")
images_path = os.path.join(PATH, "mtsd","images")
annotations_path = os.path.join(PATH, "mtsd","annotations")

detect_path = os.path.join(PATH, "yolov8-onestep-all-classes", "detect")
